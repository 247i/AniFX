...
user in an INI file next to AniFXPortable.exe called AniFXPortable.ini.
...
copy AppNamePortable.ini from this directory to AniFXPortable.ini next to
AniFXPortable.exe. The options in the INI file are as follows:
